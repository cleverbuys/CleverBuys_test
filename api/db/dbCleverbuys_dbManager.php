...
function getConnection() {
	...
	global $db_Cleverbuys_db_Url, $db_Cleverbuys_db_User, $db_Cleverbuys_db_Pass, $db_Cleverbuys_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Cleverbuys_db_Url.";dbname=".$db_Cleverbuys_db_DbName, $db_Cleverbuys_db_User, $db_Cleverbuys_db_Pass);
